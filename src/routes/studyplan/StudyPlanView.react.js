...
const StudyPlanView = props => {
    ...
    useEffect(() => {
        ...
        if (authData && authData.accessToken) {
            fetch(`http://avab-restapi.herokuapp.com/studyplan/${studyPlanID}`, {
                mode: "cors",
                headers: {
                ...
                .then(async data => {
                    ...
                    setStudyPlan(data);
                    const studyPlanItems = await fetch(`http://avab-restapi.herokuapp.com/studyplan/${studyPlanID}/studyPlanItems`, {
                        mode: "cors",
                        headers: {
                            'Accept': 'application/json',
                            'Content-Type': 'application/json',
    ...
    const handleMemberAddition = (email) => {
        fetch(`http://avab-restapi.herokuapp.com/student/${email}`, {
            mode: "cors",
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
            ...
            .then(async data => {
                ...
                const result = await fetch(`http://avab-restapi.herokuapp.com/studyplan/`, {
                    method: "PUT",
                    mode: "cors",
                    headers: {
                        'Accept': 'application/json',
    ...
    const handleProgress = (nextList, currentList, studyPlanItem) => {
        ...
        fetch(`http://avab-restapi.herokuapp.com/studyplanitem/`, {
            method: "PUT",
            mode: "cors",
            headers: {
                'Accept': 'application/json',
